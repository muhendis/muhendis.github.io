...
- On this blog: [A Prompt's Journey (1): Tokenization](post.html?slug=how-tokenization-works) — the preceding step: from raw text to token IDs —, [How LLMs work](post.html?slug=how-llms-work) — how layers process vectors —, and [A Prompt's Journey (3): Semantic Embeddings](post.html?slug=how-embeddings-work) — semantic search and vector spaces.
