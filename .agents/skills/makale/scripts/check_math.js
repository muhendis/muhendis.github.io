...
// Dynamically locate repo root by searching for assets/js/vendor/marked.umd.js
let ROOT = path.resolve(__dirname, '../../../..');
if (!fs.existsSync(path.join(ROOT, 'assets/js/vendor/marked.umd.js'))) {
  let curr = __dirname;
  while (curr !== '/' && !fs.existsSync(path.join(curr, 'assets/js/vendor/marked.umd.js'))) {
